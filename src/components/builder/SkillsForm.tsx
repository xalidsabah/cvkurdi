...
interface SkillsFormProps {
  ...
  addLanguageWithLevel: (name: string, level: string) => void;
...
export function SkillsForm({
  ...
  const getSkillSuggestions = (inputValue: string) => {
  ...
  const handleSkillAutocompleteSelect = (suggestion: string) => {
  ...
  const handleSkillInputFocus = (event: React.FocusEvent<HTMLInputElement>) => {
