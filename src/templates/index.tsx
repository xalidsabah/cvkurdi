...
let ModernTemplate, ClassicTemplate, CreativeTemplate, MinimalTemplate, NewCreativeTemplate;
...
const loadTemplates = async () => {
  if (!ModernTemplate) {
    const [
      ...
      import('../components/templates/CreativeTemplate')
    ]);
    ...
    NewCreativeTemplate = NewCreativeModule.default;
  }
};
